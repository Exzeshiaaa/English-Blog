...
export default [
  ...
  // },
  {
    ...
    description:
      'Adrian is a 4th year student in UP Diliman taking up the course of Computer Science. His interest align with bioinformatics and computer security. He aims to provide knowledge and insights with often ignored topics in the Philippines such as data security and data privacy',
